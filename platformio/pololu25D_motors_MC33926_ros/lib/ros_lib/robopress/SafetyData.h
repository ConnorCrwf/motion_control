#ifndef _ROS_robopress_SafetyData_h
#define _ROS_robopress_SafetyData_h
...
namespace robopress
{
  ...
  class SafetyData : public ros::Msg
  {
    public:
      ...
      typedef float _pressure_difference_type;
      _pressure_difference_type pressure_difference;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->stamp.nsec >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->internal_pressure);
      offset += serializeAvrFloat64(outbuffer + offset, this->external_pressure);
      offset += serializeAvrFloat64(outbuffer + offset, this->pressure_difference);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->stamp.nsec);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->internal_pressure));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->external_pressure));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->pressure_difference));
    ...
    virtual const char * getType() override { return "robopress/SafetyData"; };
    virtual const char * getMD5() override { return "23b538300afae3895d43220efd779ede"; };
