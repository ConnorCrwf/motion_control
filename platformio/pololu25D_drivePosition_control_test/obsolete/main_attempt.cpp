...
void loop() {
  ...
  //uncomment this if want to change target based on time
  //every time T is an odd multiple of 90, that will be a target encoder position of 250
  // int target = 250*sin(prevT/1e6);


  //set it to static if want to go to one position and stay
  int target = 240; // should be four revolutions, 48*5
